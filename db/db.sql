...
-- create user for n8n
CREATE USER nusern WITH PASSWORD 'npwdn';
CREATE DATABASE n8ndibi OWNER nusern;

-- create user for scraper
CREATE USER scraper WITH PASSWORD 'mavenscraper';
...
-- create user for tagger
CREATE USER tagger WITH PASSWORD 'maventagger';
...
-- create user for n8n workflow
CREATE USER transformer WITH PASSWORD 'ntransformern';
GRANT USAGE ON SCHEMA public TO transformer;
GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA public TO transformer;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE ON TABLES TO transformer;
