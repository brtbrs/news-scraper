...
public interface TaggingRepository {
    ...
    List<TagCandidate> findCandidatesFromOriginalTitle(String source, Timestamp from, Timestamp to);
    List<TagCandidate> findCandidatesFromOriginalContent(String source, Timestamp from, Timestamp to, Set<UUID> excludedContentIds);
